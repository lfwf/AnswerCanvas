...
export const recreationScenes = [llmReceivesSentenceScene, videoToolsComparisonScene, iphone18ProRumorsVideoScene, longSentenceAnalysisPracticeScene, immersiveGrammarAnalysisScene, futureAiJobsScene, aiCoreConceptsScene, skillAgentNotesScene] as const;
