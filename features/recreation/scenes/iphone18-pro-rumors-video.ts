...
export const iphone18ProRumorsVideoScene: RecreationScene = {
  ...
  elements: [
    ...
    text("connectivity", "connectivity-compare-heading", 604, 86, 610, 360, "信号与延迟 · 前后对比", { color: orange, fontSize: 40, lineHeight: 50 }),
    box("connectivity", "before-frame-conn", 605, 90, 680, 330, 430, { stroke: ink, strokeWidth: 2.2, radius: 12, roughness: .8 }),
    text("connectivity", "before-title-conn", 606, 90, 715, 330, "iPhone 17 Pro", { fontSize: 30, lineHeight: 38, textAlign: "center" }),
    box("connectivity", "before-sig-1", 607, 130, 890, 40, 90, { stroke: gray, fill: "rgba(102,100,95,.45)", strokeWidth: 1.5, radius: 4, roughness: .5 }),
    box("connectivity", "before-sig-2", 608, 185, 840, 40, 140, { stroke: gray, fill: "rgba(102,100,95,.45)", strokeWidth: 1.5, radius: 4, roughness: .5 }),
    box("connectivity", "before-sig-3", 609, 240, 790, 40, 190, { stroke: gray, fill: "rgba(102,100,95,.2)", strokeWidth: 1.5, radius: 4, roughness: .5 }),
    text("connectivity", "before-delay-label", 610, 90, 1030, 330, "延迟较高", { color: orange, fontSize: 28, lineHeight: 36, textAlign: "center" }),
    box("connectivity", "before-delay-bar", 611, 130, 1070, 250, 26, { stroke: orange, fill: "rgba(239,100,11,.4)", strokeWidth: 1.8, radius: 8, roughness: .6 }),
    stroke("connectivity", "compare-arrow", 612, "M 440 880 L 515 880 M 515 880 L 495 862 M 515 880 L 495 898", { color: orange, width: 5, roughness: 1 }),
    box("connectivity", "after-frame-conn", 613, 530, 680, 330, 430, { stroke: ink, strokeWidth: 2.2, radius: 12, roughness: .8 }),
    text("connectivity", "after-title-conn", 614, 530, 715, 330, "iPhone 18 Pro\n（C2 传闻）", { fontSize: 26, lineHeight: 34, textAlign: "center" }),
    box("connectivity", "after-sig-1", 615, 560, 920, 40, 60, { stroke: green, fill: "rgba(21,138,78,.55)", strokeWidth: 1.5, radius: 4, roughness: .5 }),
    box("connectivity", "after-sig-2", 616, 615, 880, 40, 100, { stroke: green, fill: "rgba(21,138,78,.55)", strokeWidth: 1.5, radius: 4, roughness: .5 }),
    box("connectivity", "after-sig-3", 617, 670, 835, 40, 145, { stroke: green, fill: "rgba(21,138,78,.55)", strokeWidth: 1.5, radius: 4, roughness: .5 }),
    box("connectivity", "after-sig-4", 618, 725, 790, 40, 190, { stroke: green, fill: "rgba(21,138,78,.55)", strokeWidth: 1.5, radius: 4, roughness: .5 }),
    text("connectivity", "after-delay-label", 619, 530, 1030, 330, "延迟更低", { color: green, fontSize: 28, lineHeight: 36, textAlign: "center" }),
    box("connectivity", "after-delay-bar", 620, 560, 1070, 130, 26, { stroke: green, fill: "rgba(21,138,78,.5)", strokeWidth: 1.8, radius: 8, roughness: .6 }),
    text("connectivity", "connectivity-takeaway", 621, 120, 1240, 660, "C2 基带 · Wi-Fi 7 · 连接更稳", { color: gray, fontSize: 34, lineHeight: 46, textAlign: "center" }),
    hold("connectivity", "connectivity-hold", 622),
    turn("turn-appearance", 623, "appearance"),
