...
export const aiCoreConceptsScene: RecreationScene = {
  ...
  prompt: "帮我整理一份关于 AI 核心概念与发展的手写笔记，要有结构、重点和示意图。",
  ...
  elements: [
    ...
    text("brain-perception", 46, 900, 245, 110, "感知", { color: green, fontSize: 14 }),
    ...
    stroke("icon-car", 128, "M 578 869 Q 581 851 599 851 L 622 851 Q 637 854 642 869 L 646 872 L 646 883 L 634 883 M 587 883 L 576 883 L 576 872 Z M 588 868 L 632 868 M 590 882 A 5 5 0 1 0 600 882 M 625 882 A 5 5 0 1 0 635 882", { color: blue, width: 1.55 }),
    ...
    text("mind-types", 191, 617, 1382, 90, "主要类型", { color: purple, fontSize: 16, textAlign: "center" }),
    text("mind-apps", 192, 910, 1246, 90, "应用领域", { color: orange, fontSize: 16, textAlign: "center" }),
    text("mind-trends", 193, 915, 1351, 90, "发展趋势", { color: red, fontSize: 16, textAlign: "center" }),
  ],
};
